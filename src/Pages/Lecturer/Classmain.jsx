...
import ClassNavbar from '/src/components/ClassNavbar.jsx';
import DocImage from '/src/assets/docs.jpg';
...
const Classmain = () => {
    ...
    return (
        <>
            <ClassNavbar />
            <div className=''>
                <div className="h-[calc(100vh-64px)] overflow-y-auto custom-scroll">
                    <div className="flex flex-col font-poppins p-6 gap-6 bg-white min-h-full">
                        <div className="w-full flex-shrink-0">
                            <div className="bg-cover bg-class-background text-white bg-center rounded-t-xl relative h-[190px] flex items-end p-6">
                                <div className="p-4">
                                    <h2 className="text-2xl font-semibold">Modelling and Simulation</h2>
                                </div>
                            </div>
                        </div>
